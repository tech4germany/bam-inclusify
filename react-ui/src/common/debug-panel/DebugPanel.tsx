...
import { FeatureFlags, isDebugPanelEnabled } from "../feature-flags/feature-flags";
...
const DebugPanel: FC<DebugPanelProps> = ({ featureFlagsState }) => (
  <DebugPanelContainer>
    <DebugPanelHeading>Debug Panel</DebugPanelHeading>
